...
module.exports = function (deps) {
  ...
  function onMoveCard(playerId, cardId) {
    const cannotMove = playerServiceProvider
    ...
    opponentActionLog.opponentMovedCard({
  ...
  function moveStationCard(playerId, { cardId, location }) {
    ...
    if (!moveStationCard.canMove({ cardId, location }))
      throw new CheatError("Cannot move station card");
