...
var LeaderLine = (function () {
            ...
            function (e) {
                ...
                return (
                    ...
                    (!(t = Object.getPrototypeOf(e)) ||
                        ((n =
                            t.hasOwnProperty("constructor") && t.constructor) &&
                            "function" == typeof n &&
                            i.call(n) === l))
                );
            }),
        ...
        c = (function () {
                ...
                e && (n.call(window, e), (e = null)),
                    k.forEach(function (e) {
                        ...
                        if (e.framesStart) {
                            ...
                            if (t > e.duration) {
                                if (
                                    ((n = Math.floor(t / e.duration)), e.count)
                                ) {
                                    if (n >= e.loopsLeft)
                                        return (
                                            (a =
            ...
            return {
                ...
                remove: function (n) {
                    ...
                    k.some(function (e, t) {
                        return (
                            e.animId === n && ((a = t), !(e.framesStart = null))
                        );
                    }) && k.splice(a, 1);
                },
                start: function (t, n, a) {
                    k.some(function (e) {
                        return (
                            e.animId === t && ((e.reverse = !!n), O(e, a), !0)
                        );
                    });
                },
                stop: function (t, n) {
            ...
            (e.SVGPathElement.prototype.getPathData &&
                ...
                (function () {
                    ...
                    o.prototype = {
                        ...
                        _parseNumber: function () {
                            ...
                            if (this._currentIndex !== r)
                                for (
                                    var s = this._currentIndex - 1, u = 1;
                                    r <= s;
                        ...
                        U = function (e, t, n, a, i, o, l, r, s, u) {
                            ...
                            if (u)
                                ...
                                var b = i * i,
                                    ...
                                    M =
                                        (r === s ? -1 : 1) *
                                        Math.sqrt(Math.abs(w / O));
                                (d = (M * i * E) / o + (e + n) / 2),
                                    (f = (M * -o * v) / i + (t + a) / 2),
                                    (p = Math.asin(
                                        parseFloat(((t - f) / o).toFixed(9))
                                    )),
                                    (c = Math.asin(
                                        parseFloat(((a - f) / o).toFixed(9))
                                    )),
                                    e < d && (p = Math.PI - p),
                                    n < d && (c = Math.PI - c),
                                    p < 0 && (p = 2 * Math.PI + p),
                            ...
                            return (
                                e.forEach(function (e) {
                                    if ("M" === e.type) {
                                        ...
                                        S.push({ type: "L", values: [t, n] }),
                                            (v = t),
                                            (E = n);
                                    } else if ("H" === e.type) {
                                        t = e.values[0];
                                        S.push({ type: "L", values: [t, E] }),
                                            (v = t);
                                    } else if ("V" === e.type) {
                                        n = e.values[0];
                                        S.push({ type: "L", values: [v, n] }),
                                            (E = n);
                                    } else if ("S" === e.type) {
                                        (o = e.values[0]),
                                            (l = e.values[1]),
                    ...
                    (e.SVGPathElement.prototype.setAttribute = function (e, t) {
                        ...
                        (e.SVGCircleElement.prototype.getPathData = function (
                            e
                        ) {
                        ...
                        (e.SVGEllipseElement.prototype.getPathData = function (
                            e
                        ) {
                            var t = this.cx.baseVal.value,
                                n = this.cy.baseVal.value,
                  ...
                  [0, 1].forEach(function (e) {
                      ...
                      g.socketSE[e] ||
                          (f[e].width || f[e].height
                              ? f[e].width ||
                                (b[e].socketId !== L && b[e].socketId !== I)
                                  ? f[e].height ||
                                    (b[e].socketId !== M &&
                                        b[e].socketId !== C) ||
                                    (b[e].socketId =
                                        0 <= b[e ? 0 : 1].y - f[e].top ? C : M)
                                  : (b[e].socketId =
                                        0 <= b[e ? 0 : 1].x - f[e].left ? I : L)
    ...
    function De(e, t) {
        ...
        t.line &&
            (ee.line =
                ...
                (l = !1),
                (l =
                    We(n, i, "line_color", a.lineColor, o.cur_line_color) || l),
                ...
                (ee.plug =
                    ...
                    [0, 1].forEach(function (e) {
                        ...
                        (f = We(h, c.plug_enabledSE, e, u !== ne) || f),
                            ...
                            (f =
                                We(h, c.plug_colorTraSE, e, fe(s)[0] < 1) || f),
                            u !== ne &&
                                ((i = n =
                                    (t = ae[ie[u]]).widthR * p.plugSizeSE[e]),
                            ...
                            (c.plugOutline_plugSE[e] = c.capsMaskMarker_plugSE[
                                e
                            ] = u),
                            c.plug_enabledSE[e]
                                ? ((s =
                                      (c.line_strokeWidth / pe.lineSize) *
                                      p.plugSizeSE[e]),
                            ...
                            (c.capsMaskAnchor_enabledSE[e] = !c.plug_enabledSE[
                                e
                            ]);
                    }),
                    (f =
            ...
            (t.lineOutline || ee.line) &&
                (ee.lineOutline =
                    ...
                    (S = !1),
                    (S =
                        We(r, y, "lineOutline_enabled", u.lineOutlineEnabled) ||
                        S),
                    (S =
                        We(r, y, "lineOutline_color", u.lineOutlineColor) || S),
                    (S =
                        We(
                            r,
                            y,
                            "lineOutline_colorTra",
                            fe(y.lineOutline_color)[0] < 1
                        ) || S),
                        ...
                        (v =
                            ...
                            (v =
                                We(
                                    ...
                                    e,
                                    (t =
                                        g.plugOutlineColorSE[e] ||
                                        _.lineOutline_color)
                                ) || v),
                            (v =
                                We(
                                    m,
                                    _.plugOutline_colorTraSE,
                                    e,
                                    fe(t)[0] < 1
                                ) || v),
                            a &&
                                ...
                                (t *= 2 * a.outlineBase),
                                (v =
                                    We(m, _.plugOutline_strokeWidthSE, e, t) ||
                                    v),
                                (v =
                                    We(
                                        m,
            ...
            (t.faces ||
                ...
                (ee.faces =
                    ...
                    We(
                        ...
                        ((E.lineOutlineFace.style.display = x
                            ? "inline"
                            : "none"),
                        (O = !0)),
                    b.lineOutline_enabled &&
                        ...
                        We(
                            ...
                            ((E.lineOutlineMaskShape.style.strokeWidth =
                                x + "px"),
                            (O = !0),
                            le &&
                        ...
                        [0, 1].forEach(function (n) {
                            ...
                            We(
                                ...
                                b.plug_enabledSE[n] &&
                                    ...
                                    ["markerWidth", "markerHeight"].forEach(
                                        function (e) {
                                            var t = "plug_" + e + "SE";
                                            We(
                                                E,
                                    ...
                                    b.plugOutline_enabledSE[n] &&
                                        (We(
                                            ...
                                            ((E.plugOutlineFaceSE[
                                                n
                                            ].href.baseVal = E.plugMaskShapeSE[
                                                n
                                        ...
                                        We(
                                            ...
                                            n,
                                            (x =
                                                b.plugOutline_strokeWidthSE[n]),
                                            w.apl_plugOutline_strokeWidthSE
                                        ) &&
                                            ((E.plugOutlineMaskShapeSE[
                                                n
                                            ].style.strokeWidth = x + "px"),
                                            (O = !0)),
                                        We(
                                            E,
            ...
            (ee.viewBox =
                ...
                (G.x = B.lineMask_x = B.lineOutlineMask_x = B.maskBGRect_x =
                    W.x1),
                (G.y = B.lineMask_y = B.lineOutlineMask_y = B.maskBGRect_y =
                    W.y1),
                (G.width = W.x2 - W.x1),
                (G.height = W.y2 - W.y1),
            ...
            (ee.mask =
                ...
                Y.lineMask_enabled &&
                    ...
                    Y.caps_enabled &&
                        ...
                        We(
                            ...
                            ((U.capsMaskLine.style.display = Z
                                ? "inline"
                                : "none"),
                            (q = !0)),
                        Y.capsMaskMarker_enabled &&
                ...
                Y.lineOutline_enabled &&
                    ["x", "y"].forEach(function (e) {
                        ...
                        We(U, X, t, (Z = Y[t])) &&
                            ((U.lineOutlineMask[e].baseVal.value = Z),
                            (q = !0));
                    }),
                q)),
            t.effect &&
    ...
    function Ze(s, u) {
        ...
        i &&
            ...
            (!(function (a, e) {
                ...
                function S(e) {
                    ...
                    return (
                        ...
                        t.viewBox.baseVal ||
                            t.setAttribute("viewBox", "0 0 0 0"),
                        t
                    );
                }
                ...
                (a.pathList = {}),
                    ...
                    (a.linePath = o = n.appendChild(
                        d.createElementNS(b, "path")
                    )),
                    (o.id = l = f + "-line-path"),
                    (o.className.baseVal = v + "-line-path"),
                    ue && (o.style.fill = "none"),
                    (a.lineShape = o = n.appendChild(
                        d.createElementNS(b, "use")
                    )),
                    (o.id = r = f + "-line-shape"),
                    (o.href.baseVal = "#" + l),
                    ((i = n.appendChild(d.createElementNS(b, "g"))).id = s =
                        f + "-caps"),
                    (a.capsMaskAnchorSE = [0, 1].map(function () {
                        var e = i.appendChild(d.createElementNS(b, "path"));
                        return (
                            (e.className.baseVal = v + "-caps-mask-anchor"), e
                        );
                    })),
                    ...
                    (a.capsMaskMarkerShapeSE = [0, 1].map(function (e) {
                        ...
                        return (
                            (t.className.baseVal =
                                v + "-caps-mask-marker-shape"),
                            t
                        );
                    })),
                    (a.capsMaskLine = o = i.appendChild(
                        d.createElementNS(b, "use")
                    )),
                    (o.className.baseVal = v + "-caps-mask-line"),
                    (o.href.baseVal = "#" + r),
                    (a.maskBGRect = o = m(
                        n.appendChild(d.createElementNS(b, "rect"))
                    )),
                    ...
                    (a.lineFace = o = a.face.appendChild(
                        d.createElementNS(b, "use")
                    )),
                    (o.href.baseVal = "#" + r),
                    ...
                    (a.plugMaskShapeSE = [0, 1].map(function (e) {
                        ...
                        return (
                            (t.className.baseVal = v + "-plug-mask-shape"), t
                        );
                    })),
                    (p = []),
                    ...
                    (a.plugsFace = o = a.face.appendChild(
                        d.createElementNS(b, "use")
                    )),
            ...
            (p.position =
                c(h, u, "path", m, null, null, pe.path) || p.position),
            (p.position =
                c(h, u, "startSocket", n, "socketSE", 0) || p.position),
            ...
            [u.startSocketGravity, u.endSocketGravity].forEach(function (e, t) {
                ...
                null != e &&
                    ...
                    !1 !== i &&
                        ((h.socketGravitySE[t] = i), (p.position = !0)));
            }),
            (p.line =
                d(
                    h,
            ...
            (p.line =
                d(h, u, "size", null, "lineSize", null, pe.lineSize, function (
                    e
                ) {
                    return 0 < e;
                }) || p.line),
                        ...
                        o.optionsConf.forEach(function (e) {
                            ...
                            null == e[4] || i[n] || (i[n] = []),
                                ("function" == typeof t
                                    ...
                                    ? c
                                    : d
                                ).apply(null, [i, a].concat(e.slice(1)));
                        }),
                        i
                    );
                }
        ...
        (te = {
            dash: {
                ...
                remove: function (e) {
                    ...
                    Ce(e, "apl_line_strokeWidth", te.dash.update),
                        t.dash_animId &&
                            (c.remove(t.dash_animId), (t.dash_animId = null)),
            ...
            gradient: {
                ...
                update: function (a) {
                    ...
                    [0, 1].forEach(function (e) {
                        i.gradient_colorSE[e] =
                            n.colorSE[e] || i.plug_colorSE[e];
                    }),
                        (t = l[0][0]),
                        ...
                        [0, 1].forEach(function (t) {
                            ...
                            We(
                                ...
                                (ue
                                    ? ((n = fe(n)),
                                      (a.efc_gradient_stopSE[
                                          t
                                      ].style.stopColor = n[1]),
                                      (a.efc_gradient_stopSE[
                                          t
                                      ].style.stopOpacity = n[0]))
                                    : (a.efc_gradient_stopSE[
                                          t
                                      ].style.stopColor = n)),
                                ["x", "y"].forEach(function (e) {
                                    (n = i.gradient_pointSE[t][e]) !==
                                        ...
                                        (a.efc_gradient_gradient[
                                            e + (t + 1)
                                        ].baseVal.value = o.gradient_pointSE[t][
                                            e
                                        ] = n);
                                });
                        });
                ...
                init: function (t) {
                    var e,
                        ...
                        u =
                            ...
                            (o.elmsAppend = [
                                (o.elmFilter = a = e.createElementNS(
                                    b,
                                    "filter"
                                )),
                            ]),
                ...
                update: function (e) {
                    ...
                    (a.dropShadow_dx = t = o.dx),
                        We(e, i, "dropShadow_dx", t) &&
                            ((e.efc_dropShadow_elmOffset.dx.baseVal = t),
                            (n = !0)),
                        (a.dropShadow_dy = t = o.dy),
                        We(e, i, "dropShadow_dy", t) &&
                            ((e.efc_dropShadow_elmOffset.dy.baseVal = t),
                            (n = !0)),
        ...
        (g = {
            none: {
                ...
                init: function (e, t) {
                    var n = e.curStats;
                    n.show_animId &&
                        (c.remove(n.show_animId), (n.show_animId = null)),
                        g.none.start(e, t);
                },
                start: function (e, t) {
                    g.none.stop(e, !0);
        ...
        (S = (function () {
            function e(e, t) {
                ...
                e.argOptions.every(function (e) {
                    ...
                    e.stats &&
                        (Te(a.curStats, e.stats), Te(a.aplStats, e.stats)),
        ...
        (y = {
            pointAnchor: {
                ...
                init: function (e, t) {
                    return (
                        ...
                        (e.x = y.pointAnchor.parsePercent(t.x, !0) || [
                            0.5,
                            !0,
                        ]),
                        (e.y = y.pointAnchor.parsePercent(t.y, !0) || [
                            0.5,
                            !0,
                        ]),
                        !0
                ...
                removeOption: function (e, t) {
                    var n = t.props,
                        ...
                        o =
                            n.options.anchorSE[
                                "start" === t.optionName ? 1 : 0
                            ];
                    i === o &&
                        (i =
                            o === document.body
                                ? new S(y.pointAnchor, [i])
                                : document.body),
                        (a[t.optionName] = i),
                        Ze(n, a);
                },
            ...
            areaAnchor: {
                ...
                init: function (i, e) {
                    ...
                    return (
                        ...
                        "circle" === e.shape
                            ...
                            : "polygon" === e.shape &&
                              ...
                              e.points.every(function (e) {
                                  ...
                                  return (
                                      !(
                                          !(t.x = y.pointAnchor.parsePercent(
                                              e[0],
                                              !0
                                          )) ||
                                          !(t.y = y.pointAnchor.parsePercent(
                                              e[1],
                                              !0
                                          ))
                                      ) &&
                            ...
                            : ((i.shape = "rect"),
                              (i.radius =
                                  w(e.radius) && 0 <= e.radius ? e.radius : 0)),
                        ("rect" !== i.shape && "circle" !== i.shape) ||
                            ((i.x = y.pointAnchor.parsePercent(e.x, !0) || [
                                -0.05,
                                !0,
                            ]),
                            (i.y = y.pointAnchor.parsePercent(e.y, !0) || [
                                -0.05,
                                !0,
                            ]),
                            (i.width = y.pointAnchor.parsePercent(e.width) || [
                                1.1,
                                !0,
                            ]),
                            (i.height = y.pointAnchor.parsePercent(
                                e.height
                            ) || [1.1, !0]),
                        ...
                        n.viewBox.baseVal ||
                            n.setAttribute("viewBox", "0 0 0 0"),
                        ...
                        (i.updateColor = function () {
                            var e,
                                ...
                                a = i.boundTargets.length
                                    ...
                                    : null;
                            (t.color = e =
                                i.color || (a ? a.line_color : pe.lineColor)),
                                We(i, n, "color", e) &&
                                    (i.path.style.stroke = e);
                        }),
                        ...
                        switch (t.shape) {
                            case "rect":
                                ((v = {
                                    ...
                                    width:
                                        t.width[0] * (t.width[1] ? a.width : 1),
                                    height:
                                        t.height[0] *
                                        (t.height[1] ? a.height : 1),
            ...
            captionLabel: {
                            ...
                            (u.updateSocketXY = function (e) {
                                ...
                                null != s.x &&
                                    (u.offset
                                        ...
                                        : ((t = u.height / 2),
                                          (n = Math.max(
                                              r.attach_plugSideLenSE[
                                                  u.socketIndex
                                              ] || 0,
                                              r.line_strokeWidth / 2
                                          )),
                                          (a =
                                              r.position_socketXYSE[
                                                  u.socketIndex ? 0 : 1
                                              ]),
                                              ...
                                              : ((o.x =
                                                ...
                                                (o.y =
                                                    s.socketId === M
                                                        ...
                                                        : s.y + t))),
                                    We(u, l, "x", (i = o.x)) &&
                                        (u.elmPosition.x.baseVal.getItem(
                                            0
                                        ).value = i),
                                    We(u, l, "y", (i = o.y)) &&
                                        (u.elmPosition.y.baseVal.getItem(
                                            0
                                        ).value = i + u.height));
                            }),
                ...
                unbind: function (e, t) {
                    ...
                    e.elmsAppend &&
                        ...
                        Ce(n, "svgShow", e.updateShow),
                        ue &&
                            (Ce(n, "new_edge4viewBox", e.adjustEdge),
                            De(n, {}));
                },
                removeOption: function (e, t) {
                    var n = t.props,
            ...
            pathLabel: {
                ...
                getOffsetPathData: function (e, x, n) {
                    ...
                    function w(e, t) {
                        return (
                            Math.abs(e.x - t.x) < i && Math.abs(e.y - t.y) < i
                        );
                    }
