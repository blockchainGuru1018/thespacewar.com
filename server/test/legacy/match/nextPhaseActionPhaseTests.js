        ...
        createState({
          playerStateById: {
            P1A: {
              phase: "action",
              cardsOnHand: [
                createCard({ id: "C2A", commonId: EnergyShieldId }),
              ],
              cardsInZone: [
                createCard({ id: "C1A", commonId: EnergyShieldId }),
              ],
            },
          },
        })
      ...
      assert.calledWith(
        ...
        sinon.match({
          requirements: [
            sinon.match({
              type: "drawCard",
              count: GoodKarmaDrawCardRequirementCount(),
            }),
          ],
        })
      );
        ...
        createState({
          ...
          playerStateById: {
            P1A: {
              ...
              cardsInDeck: [createCard(), createCard(), createCard()],
      ...
      assert.calledWith(
        ...
        sinon.match({
          requirements: [
            sinon.match({
              type: "discardCard",
              count: GoodKarmaDiscardCardRequirementCount(),
            }),
          ],
        })
      );
