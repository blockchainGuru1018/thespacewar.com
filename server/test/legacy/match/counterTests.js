...
module.exports = {
      ...
      this.match.restoreFromState(
        createState({
          ...
          playerStateById: {
            ...
            P2A: {
              phase: "action",
              cardsOnHand: [createCard({ id: "C1A", cost: 2 })],
              stationCards: [
                {
                  id: "S1A",
  ...
  "when counter missile played from Missiles Launched": {
    ...
    "second player should NOT have find card requirement"() {
      this.secondPlayerAsserter.refuteHasRequirement({
        type: "findCard",
      });
    },
  },
        ...
        createState({
          ...
          playerStateById: {
            ...
            P2A: {
              ...
              events: [MoveCardEvent({ turn: 1, cardId: "C3A" })],
            },
          },
        })
      );
      this.match.attackStationCard("P2A", {
        attackerCardId: "C3A",
        ...
        createState({
          ...
          playerStateById: {
            ...
            P2A: {
              ...
              cardsInZone: [createCard({ id: "C3A", defense: 1 })],
              events: [PutDownCardEvent.forTest({ cardId: "C3A" })],
            },
          },
        })
      );
