  ...
  "when first player attack card in opponents own zone": {
    async setUp() {
      ...
      this.match = createMatch({
        players: [Player("P1A"), Player("P2A", this.secondPlayerConnection)],
      });
      this.match.restoreFromState(
        createState({
          turn: 2,
      ...
      this.match.restoreFromState(
        createState({
          ...
          playerStateById: {
            ...
            P2A: {
              cardsInOpponentZone: [
                createCard({ id: "C2A", defense: 2, damage: 1 }),
              ],
              events: [MoveCardEvent({ turn: 1, cardId: "C2A" })],
            },
          },
      ...
      this.match.restoreFromState(
        createState({
          ...
          playerStateById: {
            ...
            P2A: {
              cardsInOpponentZone: [
                createCard({ id: "C2A", defense: 3, damage: 1 }),
              ],
              events: [MoveCardEvent({ turn: 1, cardId: "C2A" })],
            },
          },
          ...
          createState({
            ...
            playerStateById: {
              P1A: {
                phase: "attack",
                cardsInZone: [
                  createCard({ id: "C1A", attack: 2, type: "missile" }),
                ],
          ...
          createState({
            ...
            playerStateById: {
              P1A: {
                phase: "attack",
                cardsInZone: [
                  createCard({ id: "C1A", attack: 1, type: "missile" }),
                ],
                events: [PutDownCardEvent({ turn: 1, cardId: "C1A" })],
              },
              P2A: {
          ...
          createState({
            ...
            playerStateById: {
              P1A: {
                phase: "attack",
                cardsInOpponentZone: [
                  createCard({ id: "C1A", type: "action", attack: 1 }),
                ],
          ...
          createState({
            ...
            playerStateById: {
              P1A: {
                phase: "attack",
                cardsInOpponentZone: [
                  createCard({ id: "C1A", type: "defense", attack: 1 }),
                ],
                events: [{ type: "moveCard", cardId: "C1A", turn: 1 }],
              },
              P2A: {
          ...
          createState({
            ...
            playerStateById: {
              P1A: {
                phase: "attack",
                cardsInZone: [
                  createCard({ id: "C1A", commonId: PursuiterCommonId }),
                ],
                events: [PutDownCardEvent({ turn: 1, cardId: "C1A" })],
              },
              P2A: {
          ...
          createState({
            ...
            playerStateById: {
              ...
              P2A: {
                stationCards: [{ id: "C2A", card: createCard({ id: "C2A" }) }],
                cardsInZone: [
                  createCard({ id: "C3A", commonId: EnergyShieldCommonId }),
                ],
              },
            },
          })
        ...
        createState({
          ...
          playerStateById: {
            P1A: {
              phase: "attack",
              cardsInOpponentZone: [
                createCard({ id: "C1A", commonId: SmallRepairShip.CommonId }),
              ],
              stationCards: [flippedStationCard("S1A"), stationCard("S2A")],
              events: [
