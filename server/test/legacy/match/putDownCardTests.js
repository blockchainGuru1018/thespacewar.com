...
module.exports = {
    "when does NOT have card should throw error": function () {
        ...
        const error = catchError(() =>
            this.match.putDownCard("P1A", putDownCardOptions)
        );
    ...
    "when can afford card:": {
        async setUp() {
            ...
            this.match = createMatch({
                players: [
                    createPlayer({
                        id: "P1A",
                        connection: this.firstPlayerConnection,
                    }),
                    createPlayer({
                        id: "P2A",
        ...
        "should put card in zone"() {
            ...
            const state = this.firstPlayerConnection.stateChanged.firstCall
                .args[0];
    ...
    "when put down card in station and card is in zone": {
        ...
        "should throw error"() {
            ...
            assert.equals(
                this.error.message,
                "Cannot move card from zone to station"
            );
        },
    },
    ...
    "when put down card and is NOT your turn should throw error": function () {
        ...
        const error = catchError(() =>
            match.putDownCard("P2A", { location: "zone", cardId: "C2A" })
        );
    ...
    "Supernova:": {
                        ...
                        playerStateById: {
                            P1A: {
                                ...
                                stationCards: [
                                    ...
                                    {
                                        card: createCard({ id: "S2A" }),
                                        place: "action",
                                    },
                                    {
                                        card: createCard({ id: "S3A" }),
                                        place: "action",
                                    },
                                    {
                                        card: createCard({ id: "S3A" }),
                            ...
                            P2A: {
                                ...
                                stationCards: [
                                    {
                                        card: createCard({ id: "S4A" }),
                                        place: "action",
                                    },
                                    {
                                        card: createCard({ id: "S5A" }),
                                        place: "action",
                                    },
                                    {
                                        card: createCard({ id: "S6A" }),
                                        place: "action",
                                    },
                                ],
                            },
        ...
        "when first player put down Supernova and both players has NO station cards": {
            setUp() {
                this.firstPlayerConnection = FakeConnection2(["stateChanged"]);
                this.secondPlayerConnection = FakeConnection2(["stateChanged"]);
                const players = [
            ...
            "should Throw Cannot put down card error of type CheatDetected"() {
                const error = catchError(() =>
                    this.match.putDownCard("P1A", {
                        location: "zone",
                        cardId: "C3A",
    ...
    "Excellent work": {
        "when first player put down Excellent work": {
                            ...
                            P1A: {
                                ...
                                cardsOnHand: [
                                    createCard({
                                        id: "C1A",
                                        type: "event",
                                        commonId: ExcellentWorkCommonId,
                                    }),
                                ],
                                cardsInDeck: [
                                    createCard({ id: "C2A" }),
            ...
            "first player should get new requirement"() {
                assert.calledWith(
                    ...
                    sinon.match({
                        requirements: [
                            sinon.match({ type: "drawCard", count: 3 }),
                        ],
                    })
                );
            },
        ...
        "when has already put down station card this turn and put down Excellent work": {
            setUp() {
                ...
                this.error = catchError(() =>
                    this.match.putDownCard("P1A", options)
                );
            },
            "should NOT throw"() {
                refute(this.error);
                            ...
                            P1A: {
                                ...
                                cardsOnHand: [
                                    createCard({
                                        id: "C1A",
                                        type: "event",
                                        commonId: GrandOpportunityCommonId,
                                    }),
                                    createCard({
                                        id: "C2A",
                                        type: "event",
    ...
    "Fatal Error:": {
        "when move Fatal Error from station card to zone": {
                ...
                this.match.restoreFromState(
                    createState({
                        playerStateById: {
                            ...
                            P2A: {
                                cardsInOpponentZone: [
                                    createCard({ id: "C2A", commonId: "C2B" }),
                                ],
                                cardsInDeck: [
                                    createCard({ id: "C3A" }),
                                    createCard({ id: "C4A" }),
            ...
            "should emit FatalErrorUsed event to player"() {
                this.firstPlayerAsserter.hasEvent((event) => {
                    return (
                        ...
                        P1A: {
                            ...
                            cardsOnHand: [
                                createCard({
                                    id: "C1A",
                                    type: "event",
                                    commonId: MissilesLaunched.CommonId,
                                }),
                            ],
                            discardedCards: [
                                createCard({ id: "C2A", type: "missile" }),
                            ],
                            cardsInDeck: [
                                createCard({ id: "C3A", type: "missile" }),
                            ],
                        },
                    },
                })
    ...
    "Sabotage:": {
        ...
        "when put down sabotage on own turn in action phase": {
            ...
            "should add requirement to opponent"() {
                this.secondPlayerAsserter.hasRequirement({
                    type: "drawCard",
                    count: 1,
                    common: true,
                });
            ...
            "should NOT add find card requirement to player"() {
                this.firstPlayerAsserter.refuteHasRequirement({
                    type: "findCard",
                });
            },
        },
