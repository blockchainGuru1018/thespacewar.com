...
describe('Player timeout', () => {
    it('should force to retreat in a period of time if player disconnect on his turn', () => {
        ...
        const {match, firstPlayerConnection, firstPlayerAsserter} = setupIntegrationTest({
            playerStateById: {
                'P1A': {
                    phase: 'action',
    ...
    it('should not force retreat if next turn the last event of the player its more ' +
