<template>
  <div class="game-option">
    <div class="content-option">
      ...
      <hr />
      <p>
        Play The Space War in your browser. <br />
        To keep your score if you win make sure to register your free account or
        login using the links above.
      </p>
      <button v-if="playAsGuestOn" class="btn btn-guest" @click="playAgainstAi">
        Play against AI
      </button>
      <button v-else class="btn btn-guest" :disabled="true">
...
export default {
  ...
  methods: {
    ...
    ...guestHelpers.mapActions(["playAgainstAi"]),
  },
};
