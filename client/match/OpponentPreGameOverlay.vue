<template>
  <div class="opponentPreGameOverlay" :style="overlayStyle">
...
module.exports = {
  ...
  computed: {
    ...matchHelpers.mapState(["opponentUser", "readyPlayerIds"]),
    ...matchHelpers.mapGetters(["gameOn", "selectingStartingStationCards"]),
    overlayStyle() {
      return {
