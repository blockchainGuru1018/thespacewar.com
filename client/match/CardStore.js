...
module.exports = function (deps) {
    ...
    function canSelectMoreCardsForAction(
        state,
        getters,
        rootState,
        rootGetters
        ...
        if (state.activeAction.name === "sacrifice") {
            const opponentStationCards =
                rootGetters["match/allOpponentStationCards"];
    ...
    function startSacrifice(
        ...
        const cardData = rootGetters["match/findPlayerCardFromAllSources"](
            cardId
        );
    ...
    async function choiceDialogApplyChoice(
    ...
    async function _applyChoicePutDownAsExtraStationCard(
        ...
        dispatch("showPutDownCardAction", {
            ...
            onFinish: (location) =>
                dispatch("putDownCardAsExtraStationCard", {
                    cardData,
                    location,
                }),
    ...
    function showCardAction(
        ...
        state.checkIfCanBeSelectedForAction = (options) => {
            return checkIfCanBeSelectedForAction(
                getters.activeActionCard,
                options
            );
        };
    }
            ...
            dispatch("showCardAction", {
                ...
                checkIfCanBeSelectedForAction: (
                    ...
                    if (actionCard.commonId === TheDarkDestroyer.CommonId) {
                        ...
                        const opponentCard = rootGetters[
                            "match/createCard"
                        ](cardData, { isOpponent: isOpponentCard });
