...
const { mapGetters: mapMatchGetters } = Vuex.createNamespacedHelpers("match");

module.exports = {
  computed: {
    ...mapCardState(["choiceCardId"]),
    ...mapCardGetters(["choices"]),
    ...mapMatchGetters(["createCard"]),
    dialogVisible() {
      return this.choices.length > 0;
    },
  },
  methods: {
    ...mapCardActions(["choiceDialogCancel", "choiceDialogApplyChoice"]),
  },
};
</script>
