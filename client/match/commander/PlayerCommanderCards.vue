...
module.exports = {
  computed: {
    ...matchHelpers.mapState(["commanders"]),
    ...matchHelpers.mapGetters(["selectingStartingStationCards"]),
    ...startGameHelpers.mapGetters(["commanderCardsVisible"]),
...
<style lang="scss">
.match-selectingStartingStationCards
  .commanderCards
  .commanderCard:hover::after {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
